...
function PageImage({
  ...
  const proxyUrl = useMemo(() => {
    ...
    return `${apiBaseUrl}/proxy?url=${encodeURIComponent(url)}`;
  }, [url, isImage]);
           ...
           <div className="max-w-screen-md mx-auto pt-20 pb-20">
              ...
              <div className="mt-10 px-4 flex gap-4">
                   <button 
                        ...
                        onClick={() => navigate(`/reader?chapter_url=${encodeURIComponent(data.prev_slug)}`)}
                   ...
                   <button 
                        ...
                        onClick={() => navigate(`/reader?chapter_url=${encodeURIComponent(data.next_slug)}`)}
